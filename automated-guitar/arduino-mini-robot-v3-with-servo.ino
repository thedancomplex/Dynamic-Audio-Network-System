...
int low = 77; // desired edge of servo (0 - 180)
int high = 67; // other desired edge of servo (0 - 180)
int low0 = 77; // desired edge of servo (0 - 180)
int high0 = 67; // other desired edge of servo (0 - 180)
int low1 = 88; // desired edge of servo (0 - 180)
int high1 = 78; // other desired edge of servo (0 - 180)
int low2 = 90; // desired edge of servo (0 - 180)
int high2 = 80; // other desired edge of servo (0 - 180)
int low3 = 90; // desired edge of servo (0 - 180)
int high3 = 80; // other desired edge of servo (0 - 180)
int low4 = 90; // desired edge of servo (0 - 180)
int high4 = 80; // other desired edge of servo (0 - 180)
int low5 = 90; // desired edge of servo (0 - 180)
int high5 = 80; // other desired edge of servo (0 - 180)
